...
public class TransitionDilem extends Activity {
    AnimationDrawable anim;
    AnimationDrawable anim2;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.transitiondilem);

        ConstraintLayout fond = findViewById(R.id.fond);


        ImageView imageView = findViewById(R.id.image);
        imageView.setBackgroundResource(R.drawable.dilemanim);
        ...
        final CountDownTimer count = new CountDownTimer(4000, 1000) {
            ...
            public void onFinish() {
                Intent myIntent = new Intent(TransitionDilem.this, DilemPage.class);
