...
public class TransitionMiniJeu extends Activity {
    AnimationDrawable anim;
    AnimationDrawable anim2;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.transitionminijeu);

        ConstraintLayout fond = findViewById(R.id.fond);

        ImageView imageView = findViewById(R.id.image);
        imageView.setBackgroundResource(R.drawable.minijeuanim);
        ...
        final CountDownTimer count = new CountDownTimer(4000, 1000) {
            ...
            public void onFinish() {
                Intent myIntent = new Intent(TransitionMiniJeu.this, MiniGamePage.class);
