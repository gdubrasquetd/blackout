...
public class MiniGamePage extends Activity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.minigamepage);
        ...
        text.setText(String.format(HomePage.game.getMiniJeu(), ChoicePage.random, ChoicePage.opposite, ChoicePage.same, ChoicePage.boy, ChoicePage.girl));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(MiniGamePage.this, ChoicePage.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(MiniGamePage.this, HomePage.class);
                startActivity(myIntent);
                finish();
            }
