...
public class TransitionGlobal extends Activity {
    AnimationDrawable anim;
    AnimationDrawable anim2;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.transitionglobal);

        ConstraintLayout fond = findViewById(R.id.fond);

        ImageView imageView = findViewById(R.id.image);
        imageView.setBackgroundResource(R.drawable.globalanim);
        ...
        final CountDownTimer count = new CountDownTimer(4000, 1000) {
            ...
            public void onFinish() {
                Intent myIntent = new Intent(TransitionGlobal.this, GlobalPage.class);
