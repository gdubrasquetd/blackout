...
public class DilemPage extends Activity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dilempage);
        ...
        text.setText(String.format(HomePage.game.getDilem(), ChoicePage.random, ChoicePage.opposite, ChoicePage.same, ChoicePage.boy, ChoicePage.girl));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(DilemPage.this, ChoicePage.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(DilemPage.this, HomePage.class);
                startActivity(myIntent);
                finish();
            }
